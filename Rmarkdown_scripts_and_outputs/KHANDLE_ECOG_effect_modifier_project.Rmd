...
ggarrange(
  annotate_figure(ggarrange(a,g,
            labels = c("a","b"),ncol = 2),top = text_grob("Modifier: Age",size = 14, face = "bold")),
  annotate_figure(ggarrange(c,i,
            labels = c("c","d"),ncol = 2),top = text_grob("Modifier: Gender",size = 14, face = "bold")),
    annotate_figure(ggarrange(b,h,
            labels = c("e","f"),ncol = 2),top = text_grob("Modifier: Race/ethnicity",size = 14, face="bold")),
  nrow = 3)
dev.off()
```
...
ggarrange(
  annotate_figure(ggarrange(d,j,
            labels = c("a","b"),ncol = 2),top = text_grob("Modifier: Educational attainment",size = 14, face = "bold")),
  annotate_figure(ggarrange(e,k,
            labels = c("c","d"),ncol = 2),top = text_grob("Modifier: Family history of dementia",size = 14, face="bold")),
  annotate_figure(ggarrange(f,l,
            labels = c("e","f"),ncol = 2),top = text_grob("Modifier: Depressive symptoms",size = 14, face="bold")),
  nrow = 3)
dev.off()
```
