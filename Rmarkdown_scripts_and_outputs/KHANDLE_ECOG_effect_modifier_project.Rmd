...
baselinemodels[[3]]<-lm(raw_data_averages$logEcog12~lspline(raw_data_averages$executive_function,knots = 1))
base_model_comparison <-tab_model(baselinemodels, title = "Relation between ECog and objective cognitive performance", 
          auto.label = T,
          dv.labels = c("unadjusted memory","unadjusted executive function","executive function with linear splines"),
          digits = 3,
          ci.hyphen = ", ",
          file = "./BASE_MODELS.html")
...
f <- FigureList[[18]]
#saving one big composite figure
string<-paste0("./Figure3_ggarange.tiff")
tiff(string,res = 300,width = 2550, height = 3300)
ggarrange(
  ggarrange(a,b,
            labels = c("a","b"),ncol = 2),
...
tiff("./Figure3a.tiff",res = 400,width = 2400,height = 1600)
ggarrange(a,ncol = 1)
dev.off()
tiff("./Figure3b.tiff",res = 400,width = 2400,height = 1600)
ggarrange(b,ncol = 1)
dev.off()
tiff("./Figure3c.tiff",res = 400,width = 2400,height = 1600)
ggarrange(c,ncol = 1)
dev.off()
tiff("./Figure3d.tiff",res = 400,width = 2400,height = 1600)
ggarrange(d,ncol = 1)
dev.off()
tiff("./Figure3e.tiff",res = 400,width = 2400,height = 1600)
ggarrange(e,ncol = 1)
dev.off()
tiff("./Figure3f.tiff",res = 400,width = 2400,height = 1600)
ggarrange(f,ncol = 1)
dev.off()
```
...
```{r}
EcogSeverity
tiff("./ECog_scores.tiff",res = 400,width = 2400,height = 1600)
