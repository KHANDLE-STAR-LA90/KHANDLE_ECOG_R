...
# List of authors: 
Fabian W. Corlier (first), Crystal Shaw, Eleanor Larson, Daniel Mungas, Sarah Farias, Maria Glymour, Rachel Whitmer, (open to adding additional co-authors), Elizabeth Rose Mayeda (last)
...
baselinemodels[[3]]<-lm(raw_data_averages$logEcog12~lspline::lspline(raw_data_averages$executive_function,knots = 1))
    # require(texreg)
    # htmlreg(baselinemodels, custom.note="%stars. htmlreg")
...
[a link to a formatted output here](`r here("Rmarkdown_scripts_and_outputs","Formated_regression_tables","Formatted_model_results_memory.html")')
...
[A link to a formatted output here:](r `here("Rmarkdown_scripts_and_outputs","Formated_regression_tables","2variable_models_executive.html")`)
...
[Formatted output of the full model here](r` here("Rmarkdown_scripts_and_outputs","Formated_regression_tables","full_model_executive.html")`)
