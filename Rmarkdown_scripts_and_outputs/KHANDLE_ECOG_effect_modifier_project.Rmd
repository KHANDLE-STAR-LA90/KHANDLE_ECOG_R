...
require(knitr)
require(kableExtra)
source("/Users/fcorlier/Box/Fabian_ERM_Box/Khandle_data_analysis_FABIAN/R_KHANDLE_project_data/Khande_data_engineering.R")
```
...
```{r}
source('/Users/fcorlier/Box/Fabian_ERM_Box/Khandle_data_analysis_FABIAN/R_KHANDLE_project_data/Make_table1.R')
knitr::opts_chunk$set(echo = F, cache = F, warning=FALSE, message=FALSE)
read_chunk('/Users/fcorlier/Box/Fabian_ERM_Box/Khandle_data_analysis_FABIAN/R_KHANDLE_project_data/Make_table1.R')
```
...
knitr::opts_chunk$set(echo = F, cache = F, warning=FALSE, message=FALSE)
read_chunk('/Users/fcorlier/Box/Fabian_ERM_Box/Khandle_data_analysis_FABIAN/R_KHANDLE_project_data/Plotting.R')
```
...
source('/Users/fcorlier/Box/Fabian_ERM_Box/Khandle_data_analysis_FABIAN/R_KHANDLE_project_data/Statistical_analysis.R')
#read_chunk('/Users/fcorlier/Box/Fabian_ERM_Box/Khandle_data_analysis_FABIAN/R_KHANDLE_project_data/Statistical_analysis.R')
```
...
#### regression results:
Call:
$statDFmem\$logEcog12 ~ statDFmem\$memory*statDFmem\$AGE$

Output:

*********************************************************

[a link to a formatted output here](Formated_regression_tables/Base_model_memory.pdf)

*********************************************************
```{r}
# CRYSTAL: the .pdf files are not generated automatically, but only the .html with the same names which I have to save as pdf by hand..(didn't find a better way yet)
```
...
predicted <- predict.lm(BASEmod_mem)
hist(BASEmod_mem$residuals)
...
[a link to a formatted output here](Formated_regression_tables/2variable_models_memory.pdf)
...
[full model output here](Formated_regression_tables/full_model_memory.pdf)
...
[Here a formated output](Formated_regression_tables/Base_model_executive.pdf)
...
[A link to a formatted output here:](Formated_regression_tables/2variable_models_executive.pdf)
...
[open full resolution image here:](Figure2_ggexport.tiff)
...
[Formatted output of the full model here](Formated_regression_tables/full_model_executive.pdf)
