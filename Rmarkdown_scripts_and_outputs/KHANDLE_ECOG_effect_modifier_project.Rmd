...
ggarrange(
  annotate_figure(ggarrange(a,g,
            labels = c("A","B"),ncol = 2,common.legend = TRUE, legend="top"),fig.lab = "Modifier: Age",fig.lab.pos = "top.left",fig.lab.size = 14,fig.lab.face = "bold"),
  annotate_figure(ggarrange(c,i,
            labels = c("C","D"),ncol = 2,common.legend = TRUE, legend="top"),fig.lab = "Modifier: Gender",fig.lab.size = 14, fig.lab.face = "bold"),
    annotate_figure(ggarrange(b,h,
            labels = c("E","F"),ncol = 2,common.legend = TRUE, legend="top"),fig.lab = "Modifier: Race/ethnicity",fig.lab.size = 14, fig.lab.face="bold"),
  nrow = 3)
dev.off()
```
...
tiff(string,res = 300,width = 2550, height = 3300)
ggarrange(
  annotate_figure(ggarrange(d,j,
            labels = c("G","H"),ncol = 2, common.legend = TRUE, legend="top"),fig.lab = "Modifier: Educational attainment (in years)",fig.lab.pos = "top.left",fig.lab.size = 14,fig.lab.face = "bold"),
  annotate_figure(ggarrange(e,k,
            labels = c("I","J"),ncol = 2, common.legend = TRUE, legend="top"),fig.lab ="Modifier: Family history of dementia",fig.lab.pos = "top.left",fig.lab.size = 14,fig.lab.face = "bold"),
  annotate_figure(ggarrange(f,l,
            labels = c("K","L"),ncol = 2, common.legend = TRUE, legend="top"),fig.lab ="Modifier: Depressive symptoms",fig.lab.pos = "top.left",fig.lab.size = 14,fig.lab.face = "bold"),
  nrow = 3)
dev.off()
```
